...
import gc  
from utils.quant_utils import get_named_linears,set_op_by_name
...
class QuantLinear(nn.Module, TritonModuleMixin):
    ...
    def pack(self, linear:int_linear_fake.QuantLinear, bit, scales, zeros, g_idx=None):
        
        W = linear.prepare_for_weight(bit).data.clone()
